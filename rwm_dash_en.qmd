...
mainPanel(
  ...
  h5(HTML(
    ...
    <br>
    <br> 
           <a href='https://doi.org/10.7802/2774' target='_blank' style='font-size: 16px;'> Data is available at: Kanol, E.; Knoesel, J.; Maaß, A. (2024): Right-Wing Extremist Mobilization in Germany. Version 2.0.0. WZB Berlin Social Science Center. Dataset.</a>"
...
mainPanel(
  ...
  h5(HTML("This visualization displays the number of right-wing extremist demonstrations and participants by county from 2005 through 2022. <br>
           <a href='https://doi.org/10.7802/2774' target='_blank'style='font-size: 12px;'> Source: Kanol, E.; Knoesel, J.; Maaß, A. (2024): Right-Wing Extremist Mobilization in Germany. Version 2.0.0. WZB Berlin Social Science Center. Dataset.</a>"))
)
```
