...
mainPanel(
  ...
  h3("Far-Right Protest sizes by Federal States Over Time"),
  h5(HTML("This visualization displays the protest size and frequencies of far-right extremist demonstrations  by federal state over time. <br>
           <a href='https://data.gesis.org/sharing/#!Detail/10.7802/2256' target= '_blank' style='font-size: 12px;'> Source: Kanol, E.; Knoesel, J. (2021): Right-Wing Extremist Mobilization in Germany. Version 1.0.0. WZB Berlin Social Science Center. Dataset.</a>"))
)
```
...
output$bubblePlot <- renderPlotly({
  ...
  g <- ggplot(state_filtered, aes(
    ...
    ggtitle("Far-Right Marches by Federal States Over Time") +
    labs(
      x = "Year",
      y = "Federal State",
      color = "Federal State"
